...
const questExamples = ["Sir Aurthor rides the horse from the castle towards the right, while Ember flies in from the top right.", "The brave knight shoots at Ember with an arrow; Ember falls to the ground.", "Out of arrows, the knight drops the bow, moves right, and attacks Ember."];
